...
export default async function NewsPage() {
    return (
        <div className=' mb-[70px]'>
            ...
            <Image src='/slim-properties/images/news_building.jpg' alt='Building in snow' width={1120} height={480} className='mt-[50px] max-w-full' />
            ...
            <div className='mt-[46px] pb-[34px] flex flex-wrap border-b border-solid border-[#EDDFD0] border-opacity-50'>
                <div className={`${s.propPic} mt-[43px] w-[304px]`}>
                    <Link href={`/news/article?id=test-news-id`}>
                        <Image src='/slim-properties/images/property.jpg' alt='Property' width={304} height={293} />
                    </Link>
